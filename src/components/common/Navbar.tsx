                  ...
                  <ul className="flex flex-col mt-6 gap-2 font-medium text-gray-700 px-2">
                    ...
                    <div className="py-6 flex items-center justify-center">
                      {!role ? (
                        ...
                        <div className="w-full flex items-center justify-center gap-1 border-2 border-brandClr2 text-brandClr1 font-semibold py-1 px-4 rounded-full customShadow4 ">
                          <button
